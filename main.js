...
// this.equivdist = this.distance + (7.92*this.elecomp)
...
function processResults(results, status) {
  ...
  setTimeout(equivdistCalc, 2000);
  
  // let timeVar = setInterval(function() {
  //   console.log('D-', statusD, 'E-',statusE);
  //   if (statusD && statusE) {
...
function equivdistCalc() {
  ...
  searchResults.sort((a, b) => {a.equivdist - b.equivdist});
